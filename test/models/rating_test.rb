...
class RatingTest < ActiveSupport::TestCase
  test "valid if score is between 0 to 10" do
    0.upto(10).each do |i|
  ...
  test "promoter? retruns true if score is 9 or 10" do
    9.upto(10).each do |i|
      rating = Rating.new(score: i)
  ...
  test "passive? returns false if score is more than 8" do
    9.upto(10).each do |i|
      rating = Rating.new(score: i)
      assert_not rating.passive?
    end
  ...
  test "detractor? returns true if score is less than 6" do
    0.upto(6).each do |i|
      rating = Rating.new(score: i)
